  ...
  return (
    <div className="fixed bottom-24 sm:bottom-28 md:bottom-32 left-1/2 -translate-x-1/2 z-50">
            ...
            {actions.map((action, index) => {
              ...
              return (
                <motion.button
                  ...
                  className="absolute w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-white/5 backdrop-blur-[80px] saturate-[200%] border border-white/15 shadow-[0_8px_24px_rgba(0,0,0,0.3)] flex items-center justify-center hover:bg-white/10 active:scale-95 transition-all touch-target"
                  title={action.label}
                >
      ...
      <motion.button
        ...
        className="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-gradient-to-br from-blue-400 to-blue-600 backdrop-blur-xl border border-white/30 shadow-[0_12px_36px_rgba(59,130,246,0.5)] relative overflow-hidden flex items-center justify-center touch-target"
        whileTap={{ scale: 0.9 }}
        animate={{
